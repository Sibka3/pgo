...
public class IndexList : IHttpHandler
{
    ...
    protected void PQ_Wall_IndexList()
    {
        ...
        using (OracleConnection connection = new OracleConnection("Data Source='(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.18.18)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=appdb)))';    User Id='appdb';    Password='ytappdb123';    Persist Security Info='true';  "))
        {
