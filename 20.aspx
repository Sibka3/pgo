...
public class IndexList : IHttpHandler
{
    ...
    protected void PQ_Wall_IndexList()
    {
        ...
        using (OracleConnection connection = new OracleConnection("Data Source='(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.18.73)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=adpceggs)))';User Id='aduser';Password='aduser0-zx';Persist Security Info='true';"))
        {
