...
public class Card_OpenCard : APPBase.APPBase
{
    ...
    protected override void DoMain()
    {
        ...
        string connection_string = "Data Source='(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.18.77)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=PCEGGS)))';    User Id='pceggs';    Password='pceggs0-zx';    Persist Security Info='true';                         Pooling='true';                         Max Pool Size='50';                         Min Pool Size='5';";
        using (OracleConnection connection = new OracleConnection(connection_string)){
            OracleCommand command = new OracleCommand(test_var, connection);
            connection.Open();
