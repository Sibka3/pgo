...
public class IndexList : IHttpHandler
{
    ...
    protected void PQ_Wall_IndexList()
    {
        ...
        using (OracleConnection connection = new OracleConnection("Data Source='(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.18.15)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=pcbbs)))';    User Id='pcbbs';    Password='pcbbs0-zx';    Persist Security Info='true'; 
        {
